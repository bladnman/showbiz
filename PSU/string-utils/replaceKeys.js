...
module.exports = function (string, params, options) {
  ...
  options = options || {};
  var urlEncode =
    "urlEncode" in options ? getBooleanValue(options.urlEncode) : false;
  var encodeEntireResponse =
    "encodeEntireResponse" in options
      ? getBooleanValue(options.encodeEntireResponse)
      : false;
